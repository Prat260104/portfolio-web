    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      >
        <img
          ...
          alt="Headshot of Prateek Rai facing a camera"
        />
      </div>
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          With a strong passion for UI/UX design and full-stack development, I take projects from
          wireframes and prototyping to full-scale production, creating intuitive, scalable digital experiences.
        </p>
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
            Crafting seamless user interfaces and high-performance applications is my primary focus. As a Google Summer of Code (GSoC) contributor for InVesalius, I architect intuitive UI components, widgets, and user workflows for complex software.<br /><br />
            From designing official department portals for KIET to leading the NextGen Supercomputing Club web platform, I bridge clean aesthetics with robust engineering. When not in Figma or code, I explore creative web animations and scalable design systems.
          </p>
        </div>
      </div>
    </div>
