...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Prateek has been instrumental in designing and developing web pages for our CSE-AI and AIML departments. His eye for clean UI/UX and ability to deliver polished interfaces is truly remarkable.',
      author: 'Dr. Rekha Kashyap',
      position: 'Dean & HOD, CSE-AI & AIML, KIET',
      tags: ['UI/UX Design', 'Web Development', 'Leadership'],
      profile: testimonial1,
    },
    {
      quote:
        'Prateek has been exceptional in his GSoC contributions to InVesalius. He deeply understands requirements, crafting intuitive UI widgets and interface elements that elevate our open-source software.',
      author: 'Paulo Henrique Junqueira Amorim',
      position: 'GSoC Mentor & Core Dev, InVesalius',
      tags: ['GSoC', 'UI/UX & Widgets', 'Open Source'],
