    ...
    <div class="flex w-full flex-col">
      ...
      >
        ...
        >
          ...
          intention. I craft intuitive UI/UX website designs and build responsive full-stack solutions.
        </p>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  const servicesCardProps = [
    {
      ...
      body: 'I craft intuitive, modern, and user-centric website designs. From low-fidelity wireframes and interactive Figma prototypes to complete design systems, ensuring a delightful and seamless user experience.',
      headings: ['UI/UX Design', 'Figma Prototyping', 'Design Systems'],
  ...
  `,
    },
    {
      ...
      body: 'I specialize in developing scalable full-stack web applications from frontend interfaces to backend APIs, database architecture, and complex integrations with engaging micro-animations.',
      headings: [
        'Full-Stack Apps',
        'Modern Frameworks',
        'API & Integrations',
  ...
  `,
    },
    {
      ...
      body: 'Your website deserves high speed and responsiveness. By optimizing load times, asset delivery, and responsive layouts, I ensure your web applications run smoothly across all screens.',
      headings: [
        'Speed Optimization',
        'Responsive Layouts',
        'SEO & Accessibility',
